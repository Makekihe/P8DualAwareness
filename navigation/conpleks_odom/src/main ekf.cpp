...
class conpleks_odom{
    private:
        ...
        tf::TransformBroadcaster ekf_odom_broadcaster;
        ros::NodeHandle n;
    ...
    public:
        ...
        void pub_ekf_odom (){
            ...
            geometry_msgs::TransformStamped ekf_odom_trans;
            ekf_odom_trans.header.stamp = current_time;
            ekf_odom_trans.header.frame_id = "odom";
            ekf_odom_trans.child_frame_id = "base_footprint";

            ekf_odom_trans.transform.translation.x = ekf_odom.pose.pose.position.x;
            ekf_odom_trans.transform.translation.y = ekf_odom.pose.pose.position.y;
            ekf_odom_trans.transform.translation.z = 0.0;
            ekf_odom_trans.transform.rotation = ekf_odom.pose.pose.orientation;

            //send the transform
            ekf_odom_broadcaster.sendTransform(ekf_odom_trans);
       }
